...
for database administrators. For further details, refer to the
[Statistical system tables page](https://docs.exasol.com/db/latest/sql_references/system_tables/statistical_system_tables.htm).
